const SITES = [
  {
    ...
    intro: '已經要去駁二時，先看附近停車場；停車場不合適時，再看周邊街道路邊停車格。',
    roads: [
      {type:'has', name:'大勇路周邊', distance:'距離駁二約 100–300m', note:'可先查看附近路邊停車格，但無即時空位資料，假日不建議反覆繞太久。', maps:'https://www.google.com/maps/search/?api=1&query=高雄大勇路駁二路邊停車'},
  ...
  {
    id:'kmc', slug:'kaohsiung-music-center-parking.html', title:'高雄流行音樂中心附近停車場與路邊停車格', name:'高雄流行音樂中心', category:'市區文創與港灣', keywords:['高流停車','高雄流行音樂中心停車','高流路邊停車格','愛河灣停車'], intro:'已經要去高流時，先看周邊停車場與導航；停車場不合適時，再看周邊街道路邊停車格。',
    roads:[
      {type:'has', name:'海邊路／真愛碼頭周邊', distance:'距離高流約 200–600m', note:'周邊可能有路邊停車格或停車空間，活動日不建議反覆繞同一圈。', maps:'https://www.google.com/maps/search/?api=1&query=高雄流行音樂中心 路邊停車'},
  ...
  {
    id:'love-river', slug:'love-river-parking.html', title:'愛河附近停車場與路邊停車格', name:'愛河風景區', category:'市區文創與港灣', keywords:['愛河停車','愛河路邊停車格','愛之船停車'], intro:'已經要去愛河時，先看附近停車場；停車場不合適時，再看周邊街道路邊停車格。',
    roads:[
      {type:'has', name:'河西路／河東路周邊', distance:'距離愛河約 100–500m', note:'可先查看路邊停車格，傍晚與假日人潮較多。', maps:'https://www.google.com/maps/search/?api=1&query=愛河 河西路 河東路 停車'},
  ...
  {
    id:'xiziwan', slug:'xiziwan-parking.html', title:'西子灣附近停車場與路邊停車格', name:'西子灣', category:'海景與人文', keywords:['西子灣停車','西子灣路邊停車格','打狗英國領事館停車','鼓山渡船頭停車'], intro:'已經要去西子灣時，先看附近停車場；停車場不合適時，再看周邊街道路邊停車格。',
    roads:[
      {type:'has', name:'臨海二路周邊', distance:'距離西子灣約 300–800m', note:'可查看路邊停車格，夕陽時段與假日通常較難找。', maps:'https://www.google.com/maps/search/?api=1&query=臨海二路 西子灣 停車'},
      {type:'has', name:'鼓山渡船頭周邊道路', distance:'距離渡船頭約 100–400m', note:'適合轉往旗津前先找格位，是否可停請以現場標線為準。', maps:'https://www.google.com/maps/search/?api=1&query=鼓山渡船頭 路邊停車'},
  ...
  {
    id:'cijin', slug:'cijin-parking.html', title:'旗津附近停車場與路邊停車格', name:'旗津', category:'海景與人文', keywords:['旗津停車','旗津路邊停車格','旗津老街停車','旗津渡輪停車'], intro:'已經要去旗津時，先看附近停車場；停車場不合適時，再看周邊街道路邊停車格，避免一直亂繞。',
    roads:[
      {type:'has', name:'旗津三路周邊', distance:'距離旗津老街約 200–600m', note:'可先查看路邊停車格，假日與用餐時段不建議繞太久。', maps:'https://www.google.com/maps/search/?api=1&query=旗津三路 路邊停車'},
  ...
  {
    id:'lotus-pond', slug:'lotus-pond-parking.html', title:'蓮池潭附近停車場與路邊停車格', name:'蓮池潭', category:'海景與人文', keywords:['蓮池潭停車','蓮池潭路邊停車格','龍虎塔停車','左營孔廟停車'], intro:'蓮池潭範圍較大，先依你要去的點找附近停車場；停車場不合適時，再看周邊街道路邊停車格。',
    roads:[
      {type:'has', name:'蓮潭路周邊', distance:'依龍虎塔／春秋閣位置而定', note:'可查看路邊停車格，景點分散，建議不要只繞單一入口。', maps:'https://www.google.com/maps/search/?api=1&query=蓮潭路 路邊停車'},
  ...
  {
    id:'weiwuying', slug:'weiwuying-parking.html', title:'衛武營附近停車場與路邊停車格', name:'衛武營', category:'藝術與室內景點', keywords:['衛武營停車','衛武營路邊停車格','衛武營國家藝術文化中心停車'], intro:'已經要去衛武營時，先看周邊停車場；停車場不合適時，再看周邊街道路邊停車格。',
    roads:[
      {type:'has', name:'三多一路周邊', distance:'距離衛武營約 300–800m', note:'可查看路邊停車格，表演日不建議繞太久。', maps:'https://www.google.com/maps/search/?api=1&query=衛武營 三多一路 停車'},
  ...
  {
    id:'formosa', slug:'formosa-boulevard-parking.html', title:'美麗島站附近停車場與路邊停車格', name:'美麗島站 光之穹頂', category:'藝術與室內景點', keywords:['美麗島站停車','美麗島站路邊停車格','光之穹頂停車','六合夜市停車'], intro:'已經要去美麗島站或六合夜市附近時，先看附近停車場；停車場不合適時，再看周邊街道路邊停車格。',
    roads:[
      {type:'has', name:'中山一路／中正路周邊', distance:'距離美麗島站約 100–500m', note:'可查看路邊停車格，但路口車流多，請依標線與告示停車。', maps:'https://www.google.com/maps/search/?api=1&query=美麗島站 中山一路 停車'},
  ...
  },
  {
    ...
    roads:[
      {type:'has', name:'中山路外圍周邊', distance:'距離旗山老街約 100–500m', note:'可先查看外圍路邊停車格，假日不建議開進老街核心反覆繞。', maps:'https://www.google.com/maps/search/?api=1&query=旗山老街 中山路 停車'},
  ...
  {
    id:'meinong', slug:'meinong-parking.html', title:'美濃附近停車場與路邊停車格', name:'美濃', category:'近郊景點', keywords:['美濃停車','美濃路邊停車格','美濃老街停車','美濃民俗村停車'], intro:'美濃景點分散，先依目的地查看周邊停車場；停車場不合適時，再看周邊街道路邊停車格。',
    roads:[
      {type:'has', name:'美濃老街周邊道路', distance:'依目的地而定', note:'可查看路邊停車格，是否可停請以現場標線與告示為準。', maps:'https://www.google.com/maps/search/?api=1&query=美濃老街 路邊停車'},
